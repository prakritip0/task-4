...
import {firstStepComplete} from '../signup/FirstStep'
      ...
      <div className='profile flex flex-col items-center gap-1'>
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke='currentColor'
            className={`w-6 h-6 ${signupStep === 0 ? 'text-white' : (firstStepComplete?'hidden':'text-gray-500')} `}
          >
            <path
              strokeLinecap='round'
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke='currentColor'
            className={`w-6 h-6  text-white ${firstStepComplete ? 'block' : 'hidden'}`}
          >
