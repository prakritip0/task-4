...
const Header = ({isDarkMode, darkModeFunc}: HeaderProps) => {
  ...
  return (
    <div className={isDarkMode?" flex items-center flex-wrap py-5 px-32 justify-between bg-gray-800":'border-y-2 flex items-center flex-wrap py-5 px-32 justify-between'}>
        ...
        <div className={isDarkMode? 'theme border-2 border-white bg-gray-800 h-8 w-8 rounded-lg flex items-center justify-center p-1 cursor-pointer' : "theme border-2 border-gray-400 h-8 w-8 rounded-lg flex items-center justify-center p-1 cursor-pointer" } onClick={toggleDarkMode}>
