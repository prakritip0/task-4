...
const Header = ({isDarkMode, darkModeToggle}: HeaderProps) => {
  
  return (
    <div className={isDarkMode?" flex items-center flex-wrap py-5 px-32 justify-between bg-gray-800":'border-y-2 flex items-center flex-wrap py-5 px-32 justify-between'}>
        <div className="logo">
        ...
        <div className={isDarkMode? 'theme border-2 border-white bg-gray-800 h-8 w-8 rounded-lg flex items-center justify-center p-1 cursor-pointer' : "theme border-2 border-gray-400 h-8 w-8 rounded-lg flex items-center justify-center p-1 cursor-pointer" } onClick={darkModeToggle}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={isDarkMode ? 'hidden' : ''}>
           <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
          </svg>

          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={!isDarkMode ? 'hidden' : 'text-white'}>
