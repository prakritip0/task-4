    ...
    <div className='flex flex-col justify-between pl-2 h-full lg:py-[3rem]'>
      ...
      >
        <svg
          ...
          strokeWidth={1.5}
          stroke='currentColor'
          className={`w-6 h-6 ${signupStep === 0 ? 'text-white' : 'text-gray-500'} `}
        >
          <path
            strokeLinecap='round'
      ...
      <div className={` skills border cursor-pointer  rounded-full p-3  ${
        ...
        <svg
          ...
          strokeWidth={1.5}
          stroke='currentColor'
          className={`w-6 h-6 ${signupStep === 1 ? 'text-white' : 'text-gray-500'} `}
        >
          <path
            strokeLinecap='round'
            strokeLinejoin='round'
      ...
      <div className={`work border cursor-pointer  rounded-full p-3  ${
        ...
        <svg
          ...
          strokeWidth={1.5}
          stroke='currentColor'
          className={`w-6 h-6 ${signupStep === 2 ? 'text-white' : 'text-gray-500'} `}
        >
          <path
            strokeLinecap='round'
            strokeLinejoin='round'
      ...
      <div className={`preferences border cursor-pointer  rounded-full p-3  ${
        ...
        <svg
          ...
          strokeWidth={1.5}
          stroke='currentColor'
          className={`w-6 h-6 ${signupStep === 3 ? 'text-white' : 'text-gray-500'} `}
        >
          <path
            strokeLinecap='round'
            strokeLinejoin='round'
